...
const servicesData: ServiceItem[] = [
  {
    ...
    shortDescription: 'Strategic plans that align marketing with business goals for measurable growth.',
    icon: '📊',
    slug: 'marketing-planning',
    image: '/images/services/marketing-planning.jpg',
  },
  {
    id: '2',
    title: 'Internet Marketing',
    shortDescription: 'Comprehensive digital marketing strategies to expand your online presence.',
    icon: '🌐',
  ...
  },
  {
    ...
    shortDescription: 'High-performance PPC campaigns that drive targeted traffic and conversions.',
    icon: '📢',
    slug: 'google-ads',
  ...
  },
  {
    ...
    shortDescription: 'Full account management with content calendars and community engagement.',
    icon: '📱',
  ...
  },
  {
    ...
    shortDescription: 'Boost your organic rankings and drive sustainable traffic growth.',
    icon: '🔍',
    slug: 'seo',
  ...
  },
  {
    ...
    shortDescription: 'Expert guidance to optimize your business strategy and operations.',
    icon: '💼',
  ...
  },
  {
    ...
    shortDescription: 'Data-driven insights to understand your market and competitors.',
    icon: '📈',
